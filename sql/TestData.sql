...
--Recipe table--
INSERT INTO `Recipe`(`recipe_id`,`picture_id`,`user_id`,`type_id`,`recipe_title`,`recipe_description`,`favorite_count`,`disable`)
...
--Report table--
INSERT INTO `Report`(`banned_user_id`,`bannedby_user_id`,`report`)
